var inpListIdPer = $('#IdPermission');
var arrIdPer = [];

var inpDeletedId = $('#DeletedIdPermission');
var inpAddedId = $('#AddedIdPermission');
var deletedIds = [];
var addedIds = [];
...
$('.check-all').change(function () {
	...
	// Lấy tất cả các idPermission của các checkbox con được chọn
	let arrIdPer = [];
	parent.find('.check-permission:checked').each(function () {
		arrIdPer.push($(this).attr('data-id'));
	});

	// Cập nhật giá trị của inpListIdPer
	let inpListIdPer = $('#IdPermission');
